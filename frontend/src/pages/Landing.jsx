...
export default function Landing() {
  useEffect(() => {
    ...
    //       <h1 className="text-xl font-semibold tracking-wide">Task Force</h1>
    ...
    //     {/* INTRO SECTION (HERO + ORBIT + SUPPORT TEXT) */}
    //     <section className="relative pt-40 pb-32 px-20">
    ...
    //           <h1
    //             className="relative text-[72px] font-bold leading-tight tracking-tight max-w-4xl select-none"
    //             onMouseMove={(e) => {
    ...
    //           <div className="mt-10 ml-15 flex gap-6">
    //             {/* <button className="bg-white text-black px-6 py-3 rounded-md font-medium hover:opacity-90 transition">
    //               Get Started
    //             </button> */}
    //             <Link
    //               to="/tasks"
    //               className="border border-gray-700 bg-white text-black px-5 py-4 text-2xl rounded-md hover:bg-black hover:text-white transition inline-block"
    //             >
    //               View Dashboard
    //             </Link>
    //             </div>
    ...
    //           {/* SUPPORT TEXT (zig narrative start) */}
    //           <div className="mt-64 max-w-lg">
    ...
    //         {/* RIGHT SIDE ORBIT */}
    //         <div className="flex-1 flex justify-end  pt-20 mt-40 scale-120">
    //           <OrbitShowcase />
    //         </div>
    ...
    //     {/* DASHBOARD PREVIEW */}
    //     <section className="pt-22 pb-32 px-20">
    ...
    //       {/* <div className="mt-12 bg-[#0f0f0f] border border-gray-800 rounded-xl h-80 flex items-center justify-center">
    //         <span className="text-gray-500">
    //           Dashboard Preview
    //         </span>
    //       </div> */}
    //       <div className="mt-12 bg-[#0f0f0f] border border-gray-800 rounded-2xl p-10 shadow-xl">
    //         <PreviewCharts />
    //       </div>
    //     </section>
