...
function DashboardCharts({ tasks, employees }) {
  ...
  //     {/* STATUS PIE */}
  //     <div className="bg-white text-black p-2 rounded-lg min-w-87.5 shadow">
  ...
  //       <h3 className="font-semibold mb-2">Active Tasks by Department</h3>
  ...
  //       <h3 className="font-semibold mb-2">Task Priority Split</h3>
  //       <ResponsiveContainer width="100%" height={260}>
  //               <BarChart
  //                   data={priorityData}
  //                   margin={{ top: 10, right: 20, left: 0, bottom: 10 }}
  //               >
  //                   <XAxis dataKey="priority" interval={0} />
  //                   <YAxis />
  //                   <Tooltip />
  //                   <Bar
  //                   dataKey="count"
  ...
  //     <div className="bg-white p-4 rounded shadow">
  //           <h3 className="font-semibold mb-2">Employee Status</h3>
  //           <ResponsiveContainer width="100%" height={220}>
  //               <PieChart>
  //               <Pie
